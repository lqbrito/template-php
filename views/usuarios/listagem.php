							...
							<div class="row">
								<div class="col-md-12 text-right"> 
									<div class="btn-group" role="group" aria-label="Basic example">
										<a href='../public' class="btn btn-sm btn-primary mr-1 float-right"><i class="fas fa-reply"></i> Voltar</a>
										<form action='../controllers/usuarios.php' method="post">
											<input type = "hidden" name = "operacao" value = "form/incluir">
											<button type="submit" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Incluir</button>
										</form>
									</div>
								</div>
							</div>
