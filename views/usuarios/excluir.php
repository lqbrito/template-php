<?php
	...
	class excluirView extends View
	{
		public function view($data)
		{
			...
			$titulo = "Exclusão de usuário"; // Título da página
			$empresa = APP_EMPRESA;
							...
							<div class="row">
			                    <div class="col-lg-12">
			                        <dl class="row">
			                            ...
			                            <dd class="col-sm-10"><?php echo $usuarios['nome']; ?></dd>
			                            <dt class="col-sm-2 text-right">Login</dt>
			                            <dd class="col-sm-10"><?php echo $usuarios['login']; ?></dd>
			                        </dl>
			                    </div>
                			</div>
                			...
                			<form action='../controllers/usuarios.php' method="post">
                				...
                				<div class="row">
                					<div class="col-12">
                						...
                						<a href="../controllers/usuarios.php" class="btn btn-default" title="Fechar'"><i class="fas fa-undo"></i> Cancelar</i></a>
                					</div>
                				</div>
